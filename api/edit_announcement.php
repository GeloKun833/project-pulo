...
function handle_upload_edit(?array $file): ?string
{
...
$newImage = handle_upload_edit($_FILES['image'] ?? null);
...
try {
    ...
    $stmt->execute([
        ...
        ':description' => $description,
        ':image'       => $imageToStore,
        ':date_posted' => $datePosted !== '' ? $datePosted : $existing['date_posted'],
        ':id'          => $id,
    ]);
